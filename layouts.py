...
num_earthquakes.update_layout(
    title={'text': 'Globally Recorded Earthquakes', 'x':0.5, 'xanchor':'center'},
    xaxis_title='Year',
    yaxis_title='Count',
    # font=dict(
    #     family='Arial',
...
################################################################
            ...
            # Country dropdown and recorded earthquakes visualization
            html.Div([
                html.Div([
                    dcc.Markdown(
                        id='recorded_earthquakes_text',
                        children='''Recently, the number of recorded earthquakes has increased, but the exact increase remains unclear. With more seismic sensors, more data are available. It remains an open question whether the increase is due to increased sensor density or actual changes in earthquake frequency. One indicator of actually more earthquakes happening may be human activities that trigger earthquakes (more on this later).''',
                        style={'font-size': '16px', 'font-weight': 'bold', 'padding': '30px', 'text-align': 'right', 'background-color': '#111111', 'color': 'white', 'border-right': '1px solid #ccc'}
                    ),
                ], style={'display': 'flex', 'align-items': 'center', 'width': '40%', 'background-color': '#111111'}),

                html.Div([
                    dcc.Graph(id='earthquakes-by-year', figure=num_earthquakes, style={'display': 'inline-block', 'width': '100%', 'border-radius': '5px', 'background-color': '#111111'})
                ], style={'display': 'inline-block', 'width': '60%', 'background-color': '#111111'}),
            ], style={'background-color': '#111111', 'display': 'flex', 'border-bottom': '1px solid #e0e0e0'}),

            html.Div([
                # Left side: magnitude of earthquakes by country, and the other three visualizations
                html.Div([
                    html.P("Hover over the country bubbles to display more detailed information about the respective country in the section below.", style={'font-size': '14px', 'font-style': 'italic', 'background-color': '#111111', 'color': 'white'}),
                    dcc.Graph(id='depth-graph', style={'display': 'block', 'width': '100%', 'border-radius': '5px', 'background-color': '#111111'}),
                    html.Div([
                        dcc.Graph(id='damage-graph', style={'display': 'inline-block', 'width': '33%', 'border-radius': '5px', 'background-color': '#111111'}),
                        dcc.Graph(id='houses-graph', style={'display': 'inline-block', 'width': '33%', 'border-radius': '5px', 'background-color': '#111111'}),
                        dcc.Graph(id='deaths-graph', style={'display': 'inline-block', 'width': '33%', 'border-radius': '5px', 'background-color': '#111111'}),
                    ], style={'display': 'flex', 'background-color': '#111111'}),
                ], style={'display': 'inline-block', 'width': '75%', 'background-color': '#111111'}),


################################################################
            # right side: 
            html.Div([
            html.P("Choose the countries:", style={'font-size': '14px', 'font-style': 'italic', 'background-color': '#111111', 'color': 'white'}),
            dcc.Dropdown(
                id='country-dropdown',
            ...
            html.Div(
                ...
                dcc.Markdown(
                    id='hovering',
                    children='''Upon examining the damages and deaths, the relationship between damages and individual earthquake events becomes apparent in the three visualizations on the left due to the abrupt increases in the line graphs. This underscores the potential hazards and risks linked to individual seismic occurrences.''',
                    style={'font-size': '30px', 'text-align': 'left', 'padding': '20px', 'font-weight': 'bold', 'background-color': '#111111', 'color': 'white', 'border-left': '1px solid #ccc'}
                ),
                style={'display': 'flex', 'flex-direction': 'column', 'justify-content': 'center', 'height': '100%', 'align-items': 'center'}
            ),
            ], style={'display': 'inline-block', 'width': '25%', 'background-color': '#111111', 'height': '100vh'})





                # # Right side: dropdown, html.P, and markdown text
                # html.Div([
                #     dcc.Dropdown(
                #         id='country-dropdown',
                #         options=country_options,
                ...
                #         style={'font-size': '30px', 'text-align': 'center', 'padding': '20px', 'font-weight': 'bold', 'background-color': '#111111', 'color': 'white', 'border-left': '1px solid #ccc'}
                #     ),
                # ], style={'display': 'inline-block', 'width': '25%', 'background-color': '#111111'}),



            ], style={'background-color': '#111111', 'display': 'flex', 'border-bottom': '1px solid #ccc'}),
            ...
            #         dcc.Graph(id='earthquakes-by-year', figure=num_earthquakes, style={'display': 'inline-block', 'width': '50%', 'border-radius': '5px'})
            ...
            #     )
            # ], style={'background-color': '#111111','border-bottom': '1px solid #ccc','display': 'flex', 'align-items': 'center', 'border-radius': '5px'}),
            # ]),
...
################################################################
            ...
            dcc.Markdown(id='conclusion', 
                         children='''Our awareness of climate change is widespread, but the realization that our collective actions even influence geological processes underscores the importance of considering this aspect alongside other challenges. Only through a comprehensive understanding of human-earth interactions can we develop effective solutions to the complex problems we face.''', 
                         style={
                            'font-size': '50px',
                            'font-weight': 'bold',
                            'text-align': 'center',
